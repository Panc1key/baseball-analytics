...
export const MLB_INFERENCE_FREEZE = Object.freeze({
  ...
  shadowOnly: Object.freeze([
    ...
    'MlbWinrateStrongHomeShadow（預設 compare；Frozen B 純 skip 歷史傷美元，不進正式）',
    'MlbSurgicalAwayStrongEvShadow surgical_a（預設 off；不進正式）',
    'MlbSurgicalAwayR1MidoddsShadow surgical_b（正式 apply：客×R1×中水；回退 MLB_SURGICAL_AWAY_R1_MIDODDS_SHADOW=compare|off）',
    'MlbTotalsUnderPitcherShadow（正式 apply：Under×投手公園；回退 MLB_TOTALS_UNDER_PITCHER_SHADOW=compare|off）',
    'MlbTotalsFragileUnderShadow（預設 compare；不進正式）',
