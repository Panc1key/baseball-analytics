...
export const ASIAN_RESEARCH_FREEZE = Object.freeze({
  ...
  foldStability: {
    ...
    verdict: 'NPB 獨贏已接正式日推；logistic baseline 僅對照；KBO pause',
  },
  nextWork: [
    'NPB 正式：條件 μ + 日 TopK=3（Round5 Δ$+$138）已接線',
    '大小仍 thin-year；KBO pause；紙上帳未建',
    'MLB 鎖定 B 不變',
  ],
  shadowProtocol: {
    module: 'AsianNpbResearchShadow.js',
    formalService: 'NpbPrematchRecommend.js',
    formalRoute: 'GET /api/npb/prematch',
    wiredToFormal: true,
    formalDailyTopK: 3,
    audit: 'scripts/auditNpbResearchShadow.mjs',
    optimizeAudit: 'scripts/auditNpbRidgeShadowOptimize.mjs',
    optRound2: 'scripts/auditNpbShadowOptRound2.mjs',
    optRound3: 'scripts/auditNpbShadowOptRound3.mjs',
    optRound4: 'scripts/auditNpbShadowOptRound4.mjs',
    optRound5: 'scripts/auditNpbFormalOptRound5.mjs',
    artifact: 'tmp-npb-research-shadow.json',
    round2Artifact: 'tmp-npb-shadow-opt-round2.json',
    round3Artifact: 'tmp-npb-shadow-opt-round3.json',
    round4Artifact: 'tmp-npb-shadow-opt-round4.json',
    round5Artifact: 'tmp-npb-formal-opt-round5.json',
    savedPrimaryShadow: 'ridge_poisson_cal_same',
    savedImproveShadow: 'ridge_mu025_if_dev_ge_15',
    savedTotalsShadow: 'totals_poisson_mu025_mid',
    savedTotalsImproveShadow: 'totals_poisson_mu025_edge03',
    savedTotalsOverOnlyShadow: 'totals_poisson_mu025_edge03_over',
    rule: '獨贏正式＝條件 μ + 日 TopK=3；大小／KBO 仍影子',
  },
  kboStatus: 'paused',
});
